...
import { LayoutDashboard, GitBranch, PlusCircle, Sparkles, LogOut, UserCheck } from 'lucide-react';
  ...
  return (
    <aside className="w-20 md:w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-slate-800 space-y-4">
        <div className="bg-indigo-950/30 border border-indigo-500/20 rounded-xl p-3 hidden md:block">
        ...
        <button className="flex items-center gap-4 text-slate-500 hover:text-rose-400 transition-colors w-full px-2">
          <LogOut size={20} />
